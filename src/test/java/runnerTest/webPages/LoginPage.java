...
public class LoginPage extends ElementUtil {
    ...
    //  private By errorMessage = By.xpath("//span[contains(text(), 'Log Into Facebook')]");   ***Burasi
    ...
    //  public String getErrorMessage() {    ***Burasi
    //      return getTextFromElement(errorMessage);   ***Burasi
}
